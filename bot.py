...
"🗣️ NIIIMAGAAAAP?!",
"🗣️ SIX SEVEN!",
"ona: sen odam bo'laysan kuchuk",
"ona: sendan kora it baqsam yaxshi edi",
"ona: Qachon odam bo'lasan?",
"ona: Telefonni qo'y!",
"ona: Telefoningdan bosh ko'tarmaysan.",
"ona: Kompyuterni o'chir!",
"ona: Yana kompyuterda o'tiribsanmi?",
"ona: Qara, qo'shnining bolasi IELTS'dan 9 olibdi.",
"ona: Men sening yoshingda...",
"ona: Bizning paytimizda bunaqa narsalar yo'q edi.",
"ona: Xonangni yig'ishtir!",
"ona: Chiroqni o'chir, elektr tekin emas. bola: hana qorong'u ovqat yeyapmizku ona: gap qaytarma kuchuk",
"bola: 1ta kaampot ichaylik ona: qishda ichasan bola: hozir qishku ona: qop-qorongu qishda ichasan",
"ona: Ko'chadan uyga kirmaydi bu kuchuk. Uydan kochaga chiqmaydi bu kuchuk",
"ona: Pulni yerdan supurib topganing yoq",
"ona: Mehmon keladi, uyni yig'ishtir!",
"ona: Ertaga qilaman demagin.",
"ona: Tur, abet bo'lib kuchuk! soat 08:00",
"ona: Ko'zing buziladi, telefonga kamroq qara.",
"ona: Odamlar nima deydi?",
"ona: Odamlar tomdan tashlasa, sen ham tashla!",
"ona: Yaxshi o'qi, kelajakda o'zingga kerak bo'ladi. matimatika a + c = b + c, a = b, a + c = b + c kerak bo'ladi.",
"dada:bu sasiqcha ish qildimi bola: oyi maqtang qildimku ona: hech balo ish qilmadi kuchgacha yoqdi bola: wtf",
"ona: Boshimga qo'y!",
"mama: on my head",
"💸 Pul topish uchun ishlash kerak, bomj.",
"🥤 Bir og'iz Cola so'radi — olib keldim. kimsan? olim mani ismim",
"🍊 Mandarinni pochagi.",
...
"👀 Bot sizni kuzatmayapti... shunchaki online. yoz k###",
...
"bu ai u hato qilishi mumkin, ? odamchi hato qilishi mumkin emasmi?."
]
